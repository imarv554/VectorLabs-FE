...
export const CardHoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4  py-10",
        className,
      )}
    >
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-gray-200 dark:bg-gray-800/[0.8] block rounded-3xl"
